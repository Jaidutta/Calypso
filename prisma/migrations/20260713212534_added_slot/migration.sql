/*
  ...
  - Added the required column `type` to the `availability_exceptions` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "availability_exceptions" ADD COLUMN     "type" TEXT NOT NULL;
